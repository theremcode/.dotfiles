...
tools=("nano" "dos2unix" "yq" "jq" "curl" "wget" "git" "unzip" "zip" "unzip" "python3" "python3-pip" "python3-venv" "build-essential" "apt-transport-https" "ca-certificates" "software-properties-common" "gnupg" "zsh" "gpg" "tmux" "neofetch")
